...
*/
    ...
    //Disable OLED and Chip Select
    //Set OLED pin to high
...
*/
    ...
    //Set DC GPIO pin to high
    //We do this because write data requires it
...
*/
  ...
  // Change pin to reset pin on board
