...
void printIntroduction(){
    fillScreen(BLACK);
    drawChar(36, 64, 'S', WHITE, 0, 1);
    drawChar(42, 64, 'A', WHITE, 0, 1);
    drawChar(48, 64, 'F', WHITE, 0, 1);
    drawChar(54, 64, 'T', WHITE, 0, 1);
    drawChar(60, 64, 'E', WHITE, 0, 1);
    drawChar(66, 64, 'Y', WHITE, 0, 1);
    drawChar(72, 64, ' ', WHITE, 0, 1);
    drawChar(78, 64, 'O', WHITE, 0, 1);
    drawChar(84, 64, 'N', WHITE, 0, 1);
...
void printWarning(){
    fillScreen(BLACK);
    drawChar(36, 64, 'D', WHITE, 0, 1);
    drawChar(42, 64, 'A', WHITE, 0, 1);
    drawChar(48, 64, 'N', WHITE, 0, 1);
    drawChar(54, 64, 'G', WHITE, 0, 1);
    drawChar(60, 64, 'E', WHITE, 0, 1);
    drawChar(66, 64, 'R', WHITE, 0, 1);
    drawChar(72, 64, '!', WHITE, 0, 1);
